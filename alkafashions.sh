#!/bin/bash
# ALKAFASHIONS v1.0 is an upgrade from original ShellPhish Tool (https://github.com/thelinuxchoice/shellphish) by thelinuxchoice under GNU LICENSE 
# Coded by: @thelinuxchoice (https://github.com/thelinuxchoice/alkafashions)
# Upgraded by: @suljot_gjoka (https://github.com/whiteeagle0/alkafashions)
...
printf "     \e[101m\e[1;77m:: responsible for any misuse or damage caused by AlkaFashions.  ::\e[0m\n"
printf "     \e[101m\e[1;77m:: Only use for educational purporses!!                      ::\e[0m\n"
printf "\n"
printf "     \e[101m\e[1;77m::     ALKAFASHIONS v1.5! By @suljot_gjoka & @thelinuxchoice     ::\e[0m\n"
printf "\n"
}
